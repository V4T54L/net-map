...
// DNSRecordUseCase defines the interface for DNS record management business logic.
type DNSRecordUseCase interface {
	...
	ResolveDomain(ctx context.Context, domainName string) (*domain.DNSRecord, error)
}
